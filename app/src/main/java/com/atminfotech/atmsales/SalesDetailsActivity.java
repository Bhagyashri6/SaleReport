...
public class SalesDetailsActivity extends AppCompatActivity {
    ...
    private String[] tableHeaders = {"Item Name.", "Quantity", "Item Rate","Amount"};
    private static final String URL = "http://atm-india.in/service.asmx";
    private static final String NAMESPACE = "http://tempuri.org/";

    private static final String Brand_Soap_ACTION = "http://tempuri.org/ATMSalesDetail";
    // specifies the action
    private static final String METHOD_NAME = "ATMSalesDetail";
    ...
    public class AsynkSalesDetails extends AsyncTask<Void, Void, Void> {
      ArrayList<ModelStockReport> list = new ArrayList<>();
        ModelStockReport model;
        ProgressDialog pd = new ProgressDialog(SalesDetailsActivity.this);
        String datee, City;
        double totalAmount = 0.00, totalNetAmount = 0.00;

        public AsynkSalesDetails(String dd) {
            datee=dd;
        }
        ...
        public void onPostExecute(Void aVoid) {
            ...
            tableFixHeaders.setAdapter(new MyAdapter(SalesDetailsActivity.this, tableHeaders, list));
            total.setText(String.format("%.2f",totalAmount));
            pd.dismiss();

            super.onPostExecute(aVoid);
            if (serverissue) {
                MaterialStyledDialog dialog = new MaterialStyledDialog.Builder(SalesDetailsActivity.this)
                        .setTitle("Ooops!!!")
