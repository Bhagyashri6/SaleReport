 ...
 * @author Brais Gabín
 */
public abstract class SampleTableAdapterBank extends BaseTableAdapter {
     ...
     */
    public SampleTableAdapterBank(Context context) {
    ...
    public View getView(final int row, final int column, View converView, ViewGroup parent) {
        ...
        cellString.setOnClickListener(new View.OnClickListener() {
            ...
            /*    if (row == -1) {
                    ...
                    Intent intent = new Intent(getContext(), SalesDetailsActivity.class);
                    intent.putExtra("Bill", listbank.get(row).getItemcode());
